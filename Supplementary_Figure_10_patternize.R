...
target_D_FR <- as.matrix(read.table('E:/Research Centre/R/crispr/landmarks/KO-M/Dorsal/Forewing/KO-M-D-6H-FR.txt', h = F))
target_D_FL <- as.matrix(read.table('E:/Research Centre/R/crispr/landmarks/KO-M/Dorsal/Forewing/KO-M-D-6H-FL.txt', h = F))
target_D_HR <- as.matrix(read.table('E:/Research Centre/R/crispr/landmarks/KO-M/Dorsal/Hindwing/KO-M-D-6H-HR.txt', h = F))
target_D_HL <- as.matrix(read.table('E:/Research Centre/R/crispr/landmarks/KO-M/Dorsal/Hindwing/KO-M-D-6H-HL.txt', h = F))
target_V_FR <- as.matrix(read.table('E:/Research Centre/R/crispr/landmarks/KO-M/Ventral/Forewing/KO-M-V-6H-FR.txt', h = F))
target_V_FL <- as.matrix(read.table('E:/Research Centre/R/crispr/landmarks/KO-M/Ventral/Forewing/KO-M-V-6H-FL.txt', h = F))
target_V_HR <- as.matrix(read.table('E:/Research Centre/R/crispr/landmarks/KO-M/Ventral/Hindwing/KO-M-V-6H-HR.txt', h = F))
target_V_HL <- as.matrix(read.table('E:/Research Centre/R/crispr/landmarks/KO-M/Ventral/Hindwing/KO-M-V-6H-HL.txt', h = F))

# for setting the common wing outline
outline_D_FR <- read.table('E:/Research Centre/R/crispr/landmarks/KO-M-D-6H-FR-outline.txt', h = F)
outline_D_FL <- read.table('E:/Research Centre/R/crispr/landmarks/KO-M-D-6H-FL-outline.txt', h = F)
outline_D_HR <- read.table('E:/Research Centre/R/crispr/landmarks/KO-M-D-6H-HR-outline.txt', h = F)
outline_D_HL <- read.table('E:/Research Centre/R/crispr/landmarks/KO-M-D-6H-HL-outline.txt', h = F)
outline_V_FR <- read.table('E:/Research Centre/R/crispr/landmarks/KO-M-V-6H-FR-outline.txt', h = F)
outline_V_FL <- read.table('E:/Research Centre/R/crispr/landmarks/KO-M-V-6H-FL-outline.txt', h = F)
outline_V_HR <- read.table('E:/Research Centre/R/crispr/landmarks/KO-M-V-6H-HR-outline.txt', h = F)
outline_V_HL <- read.table('E:/Research Centre/R/crispr/landmarks/KO-M-V-6H-HL-outline.txt', h = F)

# for setting the common wing veins
lines_D_FR <- list.files(path = 'E:/Research Centre/R/crispr/landmarks/', pattern = 'KO-M-D-6H-FR-lines', full.names = T)
lines_D_FL <- list.files(path = 'E:/Research Centre/R/crispr/landmarks/', pattern = 'KO-M-D-6H-FL-lines', full.names = T)
lines_D_HR <- list.files(path = 'E:/Research Centre/R/crispr/landmarks/', pattern = 'KO-M-D-6H-HR-lines', full.names = T)
lines_D_HL <- list.files(path = 'E:/Research Centre/R/crispr/landmarks/', pattern = 'KO-M-D-6H-HL-lines', full.names = T)
lines_V_FR <- list.files(path = 'E:/Research Centre/R/crispr/landmarks/', pattern = 'KO-M-V-6H-FR-lines', full.names = T)
lines_V_FL <- list.files(path = 'E:/Research Centre/R/crispr/landmarks/', pattern = 'KO-M-V-6H-FL-lines', full.names = T)
lines_V_HR <- list.files(path = 'E:/Research Centre/R/crispr/landmarks/', pattern = 'KO-M-V-6H-HR-lines', full.names = T)
lines_V_HL <- list.files(path = 'E:/Research Centre/R/crispr/landmarks/', pattern = 'KO-M-V-6H-HL-lines', full.names = T)

# for setting the common mask
#mask_D_FR <- no extra mask needed
#mask_D_HL <- no extra mask needed
mask_D_HR <- read.table('E:/Research Centre/R/crispr/landmarks/KO-M-D-6H-HR-mask.txt', h = F)
mask_D_HL <- read.table('E:/Research Centre/R/crispr/landmarks/KO-M-D-6H-HL-mask.txt', h = F)
mask_V_FR <- read.table('E:/Research Centre/R/crispr/landmarks/KO-M-V-6H-FR-mask.txt', h = F)
mask_V_FL <- read.table('E:/Research Centre/R/crispr/landmarks/KO-M-V-6H-FL-mask.txt', h = F)
mask_V_HR <- read.table('E:/Research Centre/R/crispr/landmarks/KO-M-V-6H-HR-mask.txt', h = F)
mask_V_HL <- read.table('E:/Research Centre/R/crispr/landmarks/KO-M-V-6H-HL-mask.txt', h = F)

# for sampling RGB color target (example)
ID_target <- c('KO-M-V-6H')
prepath <- 'E:/Research Centre/R/crispr/images/KO-F/Ventral/Forewing/'
extension <- '-FR.jpg'
...
prepath <- 'E:/Research Centre/R/crispr/images/KO-F/Dorsal/Forewing/'
extension <- '-FR.jpg'
...
prepath <- 'E:/Research Centre/R/crispr/images/KO-F/Dorsal/Hindwing/'
extension <- '-HR.jpg'
...
prepath <- 'E:/Research Centre/R/crispr/images/KO-F/Ventral/Hindwing/'
extension <- '-HR.jpg'
...
prepath <- 'E:/Research Centre/R/crispr/landmarks/KO-F/Dorsal/Forewing/'
extension <- '-FR.txt'
...
prepath <- 'E:/Research Centre/R/crispr/landmarks/KO-F/Dorsal/Hindwing/'
extension <- '-HR.txt'
...
prepath <- 'E:/Research Centre/R/crispr/landmarks/KO-F/Ventral/Forewing/'
extension <- '-FR.txt'
...
prepath <- 'E:/Research Centre/R/crispr/landmarks/KO-F/Ventral/Hindwing/'
extension <- '-HR.txt'
...
save(raster_KO_F_D_FR, file = 'E:/Research Centre/R/crispr/output/raster_KO_F_D_FR.rda')
save(raster_KO_F_D_FL, file = 'E:/Research Centre/R/crispr/output/raster_KO_F_D_FL.rda')
save(raster_KO_F_D_HR, file = 'E:/Research Centre/R/crispr/output/raster_KO_F_D_HR.rda')
save(raster_KO_F_D_HL, file = 'E:/Research Centre/R/crispr/output/raster_KO_F_D_HL.rda')
save(raster_KO_F_V_FR, file = 'E:/Research Centre/R/crispr/output/raster_KO_F_V_FR.rda')
save(raster_KO_F_V_FL, file = 'E:/Research Centre/R/crispr/output/raster_KO_F_V_FL.rda')
save(raster_KO_F_V_HR, file = 'E:/Research Centre/R/crispr/output/raster_KO_F_V_HR.rda')
save(raster_KO_F_V_HL, file = 'E:/Research Centre/R/crispr/output/raster_KO_F_V_HL.rda')

load('E:/Research Centre/R/crispr/output/raster_KO_F_D_FR.rda')
load('E:/Research Centre/R/crispr/output/raster_KO_F_D_FL.rda')
load('E:/Research Centre/R/crispr/output/raster_KO_F_D_HR.rda')
load('E:/Research Centre/R/crispr/output/raster_KO_F_D_HL.rda')
load('E:/Research Centre/R/crispr/output/raster_KO_F_V_FR.rda')
load('E:/Research Centre/R/crispr/output/raster_KO_F_V_FL.rda')
load('E:/Research Centre/R/crispr/output/raster_KO_F_V_HR.rda')
load('E:/Research Centre/R/crispr/output/raster_KO_F_V_HL.rda')
...
# indicating sample images and landmarks
prepath <- 'E:/Research Centre/R/crispr/images/KO-M/Dorsal/Forewing/'
extension <- '-FR.jpg'
...
prepath <- 'E:/Research Centre/R/crispr/images/KO-M/Dorsal/Hindwing/'
extension <- '-HR.jpg'
...
prepath <- 'E:/Research Centre/R/crispr/images/KO-M/Ventral/Forewing/'
extension <- '-FR.jpg'
...
prepath <- 'E:/Research Centre/R/crispr/images/KO-M/Ventral/Hindwing/'
extension <- '-HR.jpg'
...
prepath <- 'E:/Research Centre/R/crispr/landmarks/KO-M/Dorsal/Forewing/'
extension <- '-FR.txt'
...
prepath <- 'E:/Research Centre/R/crispr/landmarks/KO-M/Dorsal/Hindwing/'
extension <- '-HR.txt'
...
prepath <- 'E:/Research Centre/R/crispr/landmarks/KO-M/Ventral/Forewing/'
extension <- '-FR.txt'
...
prepath <- 'E:/Research Centre/R/crispr/landmarks/KO-M/Ventral/Hindwing/'
extension <- '-HR.txt'
...
save(raster_KO_M_D_FR, file = 'E:/Research Centre/R/crispr/output/raster_KO_M_D_FR.rda')
save(raster_KO_M_D_FL, file = 'E:/Research Centre/R/crispr/output/raster_KO_M_D_FL.rda')
save(raster_KO_M_D_HR, file = 'E:/Research Centre/R/crispr/output/raster_KO_M_D_HR.rda')
save(raster_KO_M_D_HL, file = 'E:/Research Centre/R/crispr/output/raster_KO_M_D_HL.rda')
save(raster_KO_M_V_FR, file = 'E:/Research Centre/R/crispr/output/raster_KO_M_V_FR.rda')
save(raster_KO_M_V_FL, file = 'E:/Research Centre/R/crispr/output/raster_KO_M_V_FL.rda')
save(raster_KO_M_V_HR, file = 'E:/Research Centre/R/crispr/output/raster_KO_M_V_HR.rda')
save(raster_KO_M_V_HL, file = 'E:/Research Centre/R/crispr/output/raster_KO_M_V_HL.rda')

load('E:/Research Centre/R/crispr/output/raster_KO_M_D_FR.rda')
load('E:/Research Centre/R/crispr/output/raster_KO_M_D_FL.rda')
load('E:/Research Centre/R/crispr/output/raster_KO_M_D_HR.rda')
load('E:/Research Centre/R/crispr/output/raster_KO_M_D_HL.rda')
load('E:/Research Centre/R/crispr/output/raster_KO_M_V_FR.rda')
load('E:/Research Centre/R/crispr/output/raster_KO_M_V_FL.rda')
load('E:/Research Centre/R/crispr/output/raster_KO_M_V_HR.rda')
load('E:/Research Centre/R/crispr/output/raster_KO_M_V_HL.rda')
...
# indicating sample images and landmarks
prepath <- 'E:/Research Centre/R/crispr/images/ND-F/Dorsal/Forewing/'
extension <- '-FR.jpg'
...
prepath <- 'E:/Research Centre/R/crispr/images/ND-F/Dorsal/Hindwing/'
extension <- '-HR.jpg'
...
prepath <- 'E:/Research Centre/R/crispr/images/ND-F/Ventral/Forewing/'
extension <- '-FR.jpg'
...
prepath <- 'E:/Research Centre/R/crispr/images/ND-F/Ventral/Hindwing/'
extension <- '-HR.jpg'
...
prepath <- 'E:/Research Centre/R/crispr/landmarks/ND-F/Dorsal/Forewing/'
extension <- '-FR.txt'
...
prepath <- 'E:/Research Centre/R/crispr/landmarks/ND-F/Dorsal/Hindwing/'
extension <- '-HR.txt'
...
prepath <- 'E:/Research Centre/R/crispr/landmarks/ND-F/Ventral/Forewing/'
extension <- '-FR.txt'
...
prepath <- 'E:/Research Centre/R/crispr/landmarks/ND-F/Ventral/Hindwing/'
extension <- '-HR.txt'
...
save(raster_ND_F_D_FR, file = 'E:/Research Centre/R/crispr/output/raster_ND_F_D_FR.rda')
save(raster_ND_F_D_FL, file = 'E:/Research Centre/R/crispr/output/raster_ND_F_D_FL.rda')
save(raster_ND_F_D_HR, file = 'E:/Research Centre/R/crispr/output/raster_ND_F_D_HR.rda')
save(raster_ND_F_D_HL, file = 'E:/Research Centre/R/crispr/output/raster_ND_F_D_HL.rda')
save(raster_ND_F_V_FR, file = 'E:/Research Centre/R/crispr/output/raster_ND_F_V_FR.rda')
save(raster_ND_F_V_FL, file = 'E:/Research Centre/R/crispr/output/raster_ND_F_V_FL.rda')
save(raster_ND_F_V_HR, file = 'E:/Research Centre/R/crispr/output/raster_ND_F_V_HR.rda')
save(raster_ND_F_V_HL, file = 'E:/Research Centre/R/crispr/output/raster_ND_F_V_HL.rda')

load('E:/Research Centre/R/crispr/output/raster_ND_F_D_FR.rda')
load('E:/Research Centre/R/crispr/output/raster_ND_F_D_FL.rda')
load('E:/Research Centre/R/crispr/output/raster_ND_F_D_HR.rda')
load('E:/Research Centre/R/crispr/output/raster_ND_F_D_HL.rda')
load('E:/Research Centre/R/crispr/output/raster_ND_F_V_FR.rda')
load('E:/Research Centre/R/crispr/output/raster_ND_F_V_FL.rda')
load('E:/Research Centre/R/crispr/output/raster_ND_F_V_HR.rda')
load('E:/Research Centre/R/crispr/output/raster_ND_F_V_HL.rda')
...
# indicating sample images and landmarks
prepath <- 'E:/Research Centre/R/crispr/images/ND-M/Dorsal/Forewing/'
extension <- '-FR.jpg'
...
prepath <- 'E:/Research Centre/R/crispr/images/ND-M/Dorsal/Hindwing/'
extension <- '-HR.jpg'
...
prepath <- 'E:/Research Centre/R/crispr/images/ND-M/Ventral/Forewing/'
extension <- '-FR.jpg'
...
prepath <- 'E:/Research Centre/R/crispr/images/ND-M/Ventral/Hindwing/'
extension <- '-HR.jpg'
...
prepath <- 'E:/Research Centre/R/crispr/landmarks/ND-M/Dorsal/Forewing/'
extension <- '-FR.txt'
...
prepath <- 'E:/Research Centre/R/crispr/landmarks/ND-M/Dorsal/Hindwing/'
extension <- '-HR.txt'
...
prepath <- 'E:/Research Centre/R/crispr/landmarks/ND-M/Ventral/Forewing/'
extension <- '-FR.txt'
...
prepath <- 'E:/Research Centre/R/crispr/landmarks/ND-M/Ventral/Hindwing/'
extension <- '-HR.txt'
...
save(raster_ND_M_D_FR, file = 'E:/Research Centre/R/crispr/output/raster_ND_M_D_FR.rda')
save(raster_ND_M_D_FL, file = 'E:/Research Centre/R/crispr/output/raster_ND_M_D_FL.rda')
save(raster_ND_M_D_HR, file = 'E:/Research Centre/R/crispr/output/raster_ND_M_D_HR.rda')
save(raster_ND_M_D_HL, file = 'E:/Research Centre/R/crispr/output/raster_ND_M_D_HL.rda')
save(raster_ND_M_V_FR, file = 'E:/Research Centre/R/crispr/output/raster_ND_M_V_FR.rda')
save(raster_ND_M_V_FL, file = 'E:/Research Centre/R/crispr/output/raster_ND_M_V_FL.rda')
save(raster_ND_M_V_HR, file = 'E:/Research Centre/R/crispr/output/raster_ND_M_V_HR.rda')
save(raster_ND_M_V_HL, file = 'E:/Research Centre/R/crispr/output/raster_ND_M_V_HL.rda')

load('E:/Research Centre/R/crispr/output/raster_ND_M_D_FR.rda')
load('E:/Research Centre/R/crispr/output/raster_ND_M_D_FL.rda')
load('E:/Research Centre/R/crispr/output/raster_ND_M_D_HR.rda')
load('E:/Research Centre/R/crispr/output/raster_ND_M_D_HL.rda')
load('E:/Research Centre/R/crispr/output/raster_ND_M_V_FR.rda')
load('E:/Research Centre/R/crispr/output/raster_ND_M_V_FL.rda')
load('E:/Research Centre/R/crispr/output/raster_ND_M_V_HR.rda')
load('E:/Research Centre/R/crispr/output/raster_ND_M_V_HL.rda')
...
write.csv(area_all, 'output/data_pattern_area.csv', row.names = F)
...
save(raster_D_FR, file = 'output/raster_D_FR.rda')
save(raster_D_FL, file = 'output/raster_D_FL.rda')
save(raster_D_HR, file = 'output/raster_D_HR.rda')
save(raster_D_HL, file = 'output/raster_D_HL.rda')
save(raster_V_FR, file = 'output/raster_V_FR.rda')
save(raster_V_FL, file = 'output/raster_V_FL.rda')
save(raster_V_HR, file = 'output/raster_V_HR.rda')
save(raster_V_HL, file = 'output/raster_V_HL.rda')

load('output/raster_D_FR.rda')
load('output/raster_D_FL.rda')
load('output/raster_D_HR.rda')
load('output/raster_D_HL.rda')
load('output/raster_V_FR.rda')
load('output/raster_V_FL.rda')
load('output/raster_V_HR.rda')
load('output/raster_V_HL.rda')
...
save(raster_D_combined, file = 'output/raster_D_combined.rda')
save(raster_V_combined, file = 'output/raster_V_combined.rda')

load('output/raster_D_combined.rda')
load('output/raster_V_combined.rda')
