...
save(gwd_D_FR, file = 'output/gwd_D_FR.rda', row.names = T)
save(gwd_D_FL, file = 'output/gwd_D_FL.rda', row.names = T)
save(gwd_D_HR, file = 'output/gwd_D_HR.rda', row.names = T)
save(gwd_D_HL, file = 'output/gwd_D_HL.rda', row.names = T)
save(gwd_V_FR, file = 'output/gwd_V_FR.rda', row.names = T)
save(gwd_V_FL, file = 'output/gwd_V_FL.rda', row.names = T)
save(gwd_V_HR, file = 'output/gwd_V_HR.rda', row.names = T)
save(gwd_V_HL, file = 'output/gwd_V_HL.rda', row.names = T)

load('output/gwd_D_FR.rda')
load('output/gwd_D_FL.rda')
load('output/gwd_D_HR.rda')
load('output/gwd_D_HL.rda')
load('output/gwd_V_FR.rda')
load('output/gwd_V_FL.rda')
load('output/gwd_V_HR.rda')
load('output/gwd_V_HL.rda')
...
save(gwd_all, file = 'output/gwd_all.rda', row.names = F)
write.csv(gwd_all, file = 'output/data_gwd.csv', row.names = F)
load('output/gwd_all.rda')
